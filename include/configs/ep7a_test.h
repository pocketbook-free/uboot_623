...
#define CONFIG_VIDEO_MX50
	...
	#define CONFIG_SPLASH_IMG_SIZE 0x7D000	 
#endif
...
#define BLK_SIZE 512
#define BOOTCMD_DIAG	"vcom read; setenv bootargs console=ttymxc0,115200 root=/dev/mmcblk0p2 vcom=${vcom} rootwait;mmc read 0 0x70007FC0 0x1402 0x1800; bootm 0x70007FC0"

/*for boot cramfs*/
#define CONFIG_BOOT_CRAMFS
#define BOOTARGS_CRAMFS	"setenv bootargs root=/dev/ram0 console=ttymxc0,115200 rootfstype=cramfs rootdelay=2 ramdisk=40960 initrd=0x71000000,40M rootwait; bootm 0x70400000"
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"kernel_addr=0x70008000\0"		\
		"kernel_saddr=0x70008040\0"		\
		...
		"splashpos=m,m\0"	\
		\
		"bootargs_sd=setenv bootargs console=ttymxc0,115200  fastboot_dev=mmc0 ip=none root=/dev/mmcblk0p2 rootwait\0" \
		"bootargs_nand=setenv bootargs console=ttymxc0,115200  fastboot_dev=mmc2 ip=none root=/dev/mmcblk1p1 rootwait\0" \
		\
        ...
        "fatload_waveform_sd=mmcinfo 0; fatload mmc 0:1 ${waveform_addr} uImage; mmc write 0 ${waveform_addr} 0x2c03 0x1800\0" \
        ...
        "fatload_waveform_nand=mmcinfo 0; fatload mmc 0:1 ${waveform_addr} uImage; mmc write 2 ${waveform_addr} 0x2c03 0x1800\0" \
