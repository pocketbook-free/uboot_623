...
BSP_VERSION = 1_0_4_ep7a
VERSION = 2013
PATCHLEVEL = 03
SUBLEVEL = 20 
EXTRAVERSION = ${BSP_VERSION}
ifneq "$(SUBLEVEL)" ""
...
BSP_VERSION_FILE = $(obj)include/bsp_release_version.h
...
export	HOSTARCH HOSTOS SHELL BSP_VERSION
...
.PHONY : $(LIBS) $(TIMESTAMP_FILE) $(VERSION_FILE) $(BSP_VERSION_FILE)
...
depend dep:	$(TIMESTAMP_FILE) $(VERSION_FILE) $(BSP_VERSION_FILE) $(obj)include/autoconf.mk
...
$(SUBDIRS) $(TIMESTAMP_FILE) $(VERSION_FILE) $(BSP_VERSION_FILE) gdbtools updater env depend \
...
clean:
	...
	@rm -f $(TIMESTAMP_FILE) $(VERSION_FILE) $(BSP_VERSION_FILE)
	@find $(OBJTREE) -type f \
